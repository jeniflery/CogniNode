 ...
 * This file demonstrates how to integrate Cogninode with a web frontend
 */

// For React/Vue/Angular applications
export class CogninodeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CogninodeClient(provider, contractAddress);
